...
struct lept_member {
    char *k; size_t klen;   /* member key: string pointer and string length */
...
enum {
    ...
    LEPT_PARSE_MISS_KEY,                    /* parse object */
...
/* stringfy: lept_value --> json-encoded string 
 * length: optional parameters, json string length
 */
